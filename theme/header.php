   ...
   <nav class="p-2 navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportContent">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <?php //If users are not signed in, they are unable to access the orders page. ?>
        ...
        <?php //If the user is not logged in, the Sign In and Sign Up buttons are displayed. ?>
        <?php if (!isset($_SESSION['is_logged'])) : ?>
        ...
        <?php //If the user is logged in, the Sign Out button is displayed in place of Sign In and Sign Up. ?>
        <?php else : ?>
            <div class="form-inline">
